...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Parrotcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"parrotcointools.com", "192.168.72.129"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"parrotcointools.com", "testnet-seed.parrotcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Parrotcoin is probably already running."), addrBind.ToString().c_str());
        else
